...
export default class Login {
  ...
  handleSubmitEmployee = e => {
    if (!e.target.querySelector(`input[data-testid="employee-email-input"]`)) {
      console.log('Erreur input employee value dans la class login');
      return;
    }
    const user = {
      type: 'Employee',
  ...
  handleSubmitAdmin = e => {
    if (!e.target.querySelector(`input[data-testid="admin-email-input"]`)) {
      console.log('Erreur input admin value dans la class login');
      return;
    }
    const user = {
      type: 'Admin',
